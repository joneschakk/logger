...
#ifndef __LOGGER_COMPANION_HPP__
#define __LOGGER_COMPANION_HPP__
...
const std::string EXEC_NAME = "logger-companion";
const std::string LOGROTATE_CONF_FILE_SUFFIX = ".logrotate.conf";
const std::string LOGROTATE_STATE_FILE_SUFFIX = ".logrotate.state";

struct CmdFlags : public virtual flags::FlagsBase
{
  ...
  CmdFlags()
  {
    ...
    add(&CmdFlags::logrotate_options,
        "logrotate_options",
    ...
    add(&CmdFlags::log_filename,
        "log_filename",
        "Absolute path to the leading log file.\n"
        "NOTE: This command will also create two files by appending\n"
        "'" +
            LOGROTATE_CONF_FILE_SUFFIX + "' and '" + LOGROTATE_STATE_FILE_SUFFIX + "' to the end of\n"
    ...
    add(&CmdFlags::target_path,
        "target_path",
        "The user defined path passed from mesos::internal::logger flag in liblogrotate");
  }
...
#endif // __LOGGER_COMPANION_HPP__
